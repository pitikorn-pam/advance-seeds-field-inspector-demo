...
- [ ] 20.8 Android annotation verification — TFLite NMS output was normalized `0..1`, so decode it as normalized boxes and cap native-live effective score threshold at 0.25; verify Banana detections draw on the Z Flip 7 FE when the model returns class 46.
