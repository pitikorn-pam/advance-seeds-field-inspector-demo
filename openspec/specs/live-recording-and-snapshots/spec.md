# live-recording-and-snapshots Specification

## Purpose
Video recording during live capture and in-session snapshots to Photos, with Supabase Storage retention and seed analysis from video thumbnails.
