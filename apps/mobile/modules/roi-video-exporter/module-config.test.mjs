...
test("ROI video exporter Expo module is registered for Apple and Android", () => {
  ...
  assert.deepEqual(config.android.modules, ["com.advanceseeds.roivideo.AdvanceSeedsRoiVideoExporterModule"]);
  assert.equal(existsSync(join(root, "ios/AdvanceSeedsRoiVideoExporterModule.swift")), true);
  assert.equal(existsSync(join(root, "android/src/main/java/com/advanceseeds/roivideo/AdvanceSeedsRoiVideoExporterModule.kt")), true);
});
